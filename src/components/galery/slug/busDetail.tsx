...
export default function BusDetail() {
  const imageList = Array.from({length: 15}, (_, i) => <Image key={i} src={`/EventGalery/Bus Launching/${i+1}.webp`} alt="galery" className="border-dashed border-white border-4" width={1920} height={1080} />)
  return (
    <>
