...
export default function Hut45Detail() {
  const imageList = Array.from({length: 6}, (_, i) => <Image key={i} src={`/EventGalery/HUT45/${i+1}.webp`} alt="gallery" className="border-dashed border-white border-4" width={1920} height={1080} />)
  return (
    <>
